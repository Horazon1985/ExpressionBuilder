...
public abstract class ComputationBounds {
    ...
    public static final int BOUND_COMMAND_MAX_DEGREE_OF_POLYNOMIAL = getBound("BOUND_COMMAND_MAX_DEGREE_OF_POLYNOMIAL");
    ...
    public static final int BOUND_ALGEBRA_MAX_POWER_OF_TWO_FOR_COMPUTING_VALUES_OF_TRIGONOMETRICAL_FUNCTIONS = getBound("BOUND_ALGEBRA_MAX_POWER_OF_TWO_FOR_COMPUTING_VALUES_OF_TRIGONOMETRICAL_FUNCTIONS");
    ...
    public static final int BOUND_ALGEBRA_MAX_DEGREE_OF_POLYNOMIAL_FOR_DECOMPOSITION = getBound("BOUND_ALGEBRA_MAX_DEGREE_OF_POLYNOMIAL_FOR_DECOMPOSITION");
    ...
    public static final int BOUND_NUMERIC_DEFAULT_NUMBER_OF_INTERVALS = getBound("BOUND_NUMERIC_DEFAULT_NUMBER_OF_INTERVALS");
    public static final int BOUND_NUMERIC_MAX_OPERATOR_NORM_TO_COMPUTE_MATRIX_FUNCTION = getBound("BOUND_NUMERIC_MAX_OPERATOR_NORM_TO_COMPUTE_MATRIX_FUNCTION");
