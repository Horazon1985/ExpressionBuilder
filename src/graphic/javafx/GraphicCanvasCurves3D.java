...
public class GraphicCanvasCurves3D extends AbstractGraphicCanvas3D {
     ...
     */
    private int[][] convertCurveToGraphicalCurve(GraphicsContext gc) {
     ...
     */
    private void drawCurve3D(GraphicsContext gc) {
        ...
        int[][] graphicalCurve = convertCurveToGraphicalCurve(gc);
