...
public class GraphicCanvasSurface extends AbstractGraphicCanvas3D {
     ...
     */
    private void drawSurfaceFromSurfaceForGraphic(GraphicsContext gc) {
     ...
     */
    private void drawSurface(GraphicsContext gc) {
        ...
        drawLevelsBottom(gc);
        drawSurfaceFromSurfaceForGraphic(gc);
