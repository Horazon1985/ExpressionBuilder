...
public enum TypeSimplify {
    ...
    simplify_factorize_all_but_rationals_in_sums, simplify_factorize_all_but_rationals_in_differences, 
    simplify_factorize_in_sums, simplify_factorize_in_differences, simplify_reduce_quotients, 
    simplify_reduce_leadings_coefficients, simplify_algebraic_expressions,
