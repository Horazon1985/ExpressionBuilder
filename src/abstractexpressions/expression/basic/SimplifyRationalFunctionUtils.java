        ...
        if (f.isFunction() && f.contains(var)) {
            ...
            if (f.isFunction(TypeFunction.sin) || f.isFunction(TypeFunction.cos)
                ...
                if (f.isFunction(TypeFunction.sin)) {
                    return SimplifyTrigonometricalRelationsUtils.getSinOfMultipleArgument(var, n);
                } else if (f.isFunction(TypeFunction.cos)) {
                    return SimplifyTrigonometricalRelationsUtils.getCosOfMultipleArgument(var, n);
                }
            }
        }
        return f;
    ...
    public static Expression expandRationalFunctionInTrigonometricalFunctions(Expression f, TypeExpansion type) {
        ...
        if (f.isFunction()) {
            ...
            if (f.isFunction(TypeFunction.sin) || f.isFunction(TypeFunction.cos)
                ...
                if (f.isFunction(TypeFunction.sin)) {
                    return SimplifyTrigonometricalRelationsUtils.getSinOfMultipleArgument(variable, n);
                } else if (f.isFunction(TypeFunction.cos)) {
                    return SimplifyTrigonometricalRelationsUtils.getCosOfMultipleArgument(variable, n);
                }
            }
        }
        return f;
