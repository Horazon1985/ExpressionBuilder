...
import abstractexpressions.expression.basic.SimplifyTrigonometricalRelationsUtils;
import abstractexpressions.expression.basic.SimplifyUtilities;
import static abstractexpressions.expression.integration.GeneralIntegralUtils.indefiniteIntegration;
 ...
 */
public abstract class SpecialIntegrationUtils extends GeneralIntegralUtils {
    ...
    public static Expression integrateRationalFunction(Operator expr) throws EvaluationException, NotAlgebraicallyIntegrableException {
        ...
        if (!PartialFractionDecompositionUtils.isRationalFunctionInCanonicalForm(f, var)) {
        ...
        BigInteger degNnumerator = SimplifyPolynomialUtils.getDegreeOfPolynomial(((BinaryOperation) f).getLeft(), var);
        ...
        Expression partialFractionDecompositionOfF = PartialFractionDecompositionUtils.getPartialFractionDecomposition(f, var);
    ...
    public static Expression integrateQuotientOfLinearPolynomialAndPowerOfQuadraticPolynomial(Operator expr)
        ...
        if (f.isNotQuotient() || ((BinaryOperation) f).getRight().isNotPower()
                ...
                || !SimplifyPolynomialUtils.isPolynomial(((BinaryOperation) ((BinaryOperation) f).getRight()).getLeft(), var)) {
            throw new NotAlgebraicallyIntegrableException();
        }

        BigInteger degNumerator = SimplifyPolynomialUtils.getDegreeOfPolynomial(((BinaryOperation) f).getLeft(), var);
        BigInteger degDenominator = SimplifyPolynomialUtils.getDegreeOfPolynomial(((BinaryOperation) ((BinaryOperation) f).getRight()).getLeft(), var);
        ...
        ExpressionCollection coefficientsDenominator = SimplifyPolynomialUtils.getPolynomialCoefficients(((BinaryOperation) ((BinaryOperation) f).getRight()).getLeft(), var);
        ...
        Expression denominator = SimplifyPolynomialUtils.getPolynomialFromCoefficients(coefficientsDenominator, var);
    ...
    private static boolean isExponentialFunction(Expression f, String var) {
        return f.isFunction(TypeFunction.exp) && SimplifyPolynomialUtils.isPolynomial(((Function) f).getLeft(), var)
                && SimplifyPolynomialUtils.getDegreeOfPolynomial(((Function) f).getLeft(), var).compareTo(BigInteger.ONE) == 0;
    }

    private static boolean isTrigonometricalFunction(Expression f, String var) {
        return (f.isFunction(TypeFunction.cos) || f.isFunction(TypeFunction.sin)) && SimplifyPolynomialUtils.isPolynomial(((Function) f).getLeft(), var)
                && SimplifyPolynomialUtils.getDegreeOfPolynomial(((Function) f).getLeft(), var).compareTo(BigInteger.ONE) == 0;
    }
    ...
    public static Expression integrateProductOfPolynomialAndPowerOfTrigonometricFunction(Operator expr) throws EvaluationException, NotAlgebraicallyIntegrableException {
        ...
        if (SimplifyPolynomialUtils.isPolynomial(factors.get(1), var)) {
        ...
        if (SimplifyPolynomialUtils.isPolynomial(factors.get(0), var)
                ...
                && SimplifyPolynomialUtils.isPolynomial(((Function) ((BinaryOperation) factors.get(1)).getLeft()).getLeft(), var)) {

            BigInteger degPolynomial = SimplifyPolynomialUtils.getDegreeOfPolynomial(factors.get(0), var);
            BigInteger exponentOfTrigonometricFunction = ((Constant) ((BinaryOperation) factors.get(1)).getRight()).getBigIntValue();
            BigInteger degArgument = SimplifyPolynomialUtils.getDegreeOfPolynomial(((Function) ((BinaryOperation) factors.get(1)).getLeft()).getLeft(), var);
    ...
    private static Expression integrateExpOfLinearFunction(Expression expArgument, String var) throws EvaluationException, NotAlgebraicallyIntegrableException {
        if (!SimplifyPolynomialUtils.isPolynomial(expArgument, var)
                || SimplifyPolynomialUtils.getDegreeOfPolynomial(expArgument, var).compareTo(BigInteger.ONE) != 0) {
            throw new NotAlgebraicallyIntegrableException();
        }
        ExpressionCollection coefficients = SimplifyPolynomialUtils.getPolynomialCoefficients(expArgument, var);
    ...
    public static Expression integrateProductOfExpSin(Expression expArgument, Expression sinArgument, String var) throws EvaluationException, NotAlgebraicallyIntegrableException {
        ...
        ExpressionCollection coefficientsInExp = SimplifyPolynomialUtils.getPolynomialCoefficients(expArgument, var);
        ExpressionCollection coefficientsInSin = SimplifyPolynomialUtils.getPolynomialCoefficients(sinArgument, var);
    ...
    public static Expression integrateProductOfExpCos(Expression expArgument, Expression cosArgument, String var) throws EvaluationException, NotAlgebraicallyIntegrableException {
        ...
        ExpressionCollection coefficientsInExp = SimplifyPolynomialUtils.getPolynomialCoefficients(expArgument, var);
        ExpressionCollection coefficientsInCos = SimplifyPolynomialUtils.getPolynomialCoefficients(cosArgument, var);
    ...
    private static Expression integrateSqrtOfQuadraticFunction(Operator expr) throws EvaluationException, NotAlgebraicallyIntegrableException {
        ...
        ExpressionCollection coefficients = SimplifyPolynomialUtils.getPolynomialCoefficients(((BinaryOperation) f).getLeft(), var);
    ...
    public static Expression integrateProductOfLinearPolynomialAndOddPowerOfSqrtOfQuadraticPolynomial(Operator expr) throws EvaluationException, NotAlgebraicallyIntegrableException {
        ...
        if (f.isProduct()) {
            ...
            if (SimplifyPolynomialUtils.isPolynomial(factorLeft, var)) {
                coefficientsPolynomial = SimplifyPolynomialUtils.getPolynomialCoefficients(factorLeft, var);
                coefficientsQuadraticPolynomial = SimplifyPolynomialUtils.getPolynomialCoefficients(((BinaryOperation) factorRight).getLeft(), var);
                n = (((Constant) ((BinaryOperation) ((BinaryOperation) factorRight).getRight()).getLeft()).getValue().intValue() - 1) / 2;
            } else {
                coefficientsPolynomial = SimplifyPolynomialUtils.getPolynomialCoefficients(factorRight, var);
                coefficientsQuadraticPolynomial = SimplifyPolynomialUtils.getPolynomialCoefficients(((BinaryOperation) factorLeft).getLeft(), var);
            ...
            coefficientsQuadraticPolynomial = SimplifyPolynomialUtils.getPolynomialCoefficients(((BinaryOperation) f).getLeft(), var);
         ...
         */
        Expression firstSummand = d.mult(SimplifyPolynomialUtils.getPolynomialFromCoefficients(coefficientsQuadraticPolynomial, var).pow(2 * n + 3, 2)).div(new Constant(2 * n + 3).mult(a));
        Expression factor = e.sub(d.mult(b).div(TWO.mult(a)));
        Object[] params = new Object[2];
        params[0] = SimplifyPolynomialUtils.getPolynomialFromCoefficients(coefficientsQuadraticPolynomial, var).pow(2 * n + 1, 2);
        params[1] = var;
    ...
    public static Expression integrateProductOfPolynomialAndOddPowerOfSqrtOfQuadraticPolynomial(Operator expr) throws EvaluationException, NotAlgebraicallyIntegrableException {
        ...
        ExpressionCollection[] quotient = SimplifyPolynomialUtils.polynomialDivision(coefficientsPolynomial, coefficientsOfPowerOfQuadraticPolynomial);
        ...
        /* 
         ...
         + Q(x)*(a*x^2+b*x+c)^n.
         */
        Expression firstSummand = SimplifyPolynomialUtils.getPolynomialFromCoefficients(quotient[0], var).mult(SimplifyPolynomialUtils.getPolynomialFromCoefficients(coefficientsQuadraticPolynomial, var).pow(2 * n + 2 * maxExponent + 1, 2));
        Expression secondSummand = SimplifyPolynomialUtils.getPolynomialFromCoefficients(quotient[1], var).mult(SimplifyPolynomialUtils.getPolynomialFromCoefficients(coefficientsQuadraticPolynomial, var).pow(2 * n + 1, 2));
    ...
    private static boolean isProductOfPolynomialAndOddPowerOfSqrtOfQuadraticFunction(Expression f, String var) {
        ...
        if (f.isPower()
                ...
                && ((BinaryOperation) ((BinaryOperation) f).getRight()).getRight().equals(TWO)
                && SimplifyPolynomialUtils.isPolynomial(((BinaryOperation) f).getLeft(), var)
                && SimplifyPolynomialUtils.getDegreeOfPolynomial(((BinaryOperation) f).getLeft(), var).compareTo(BigInteger.valueOf(2)) == 0) {
        ...
        if (SimplifyPolynomialUtils.isPolynomial(leftFactor, var)
                && rightFactor.isPower()
                ...
                && SimplifyPolynomialUtils.isPolynomial(((BinaryOperation) rightFactor).getLeft(), var)
                && SimplifyPolynomialUtils.getDegreeOfPolynomial(((BinaryOperation) rightFactor).getLeft(), var).compareTo(BigInteger.valueOf(2)) == 0) {
        ...
        if (SimplifyPolynomialUtils.isPolynomial(rightFactor, var)
                && leftFactor.isPower()
                ...
                && SimplifyPolynomialUtils.isPolynomial(((BinaryOperation) leftFactor).getLeft(), var)
                && SimplifyPolynomialUtils.getDegreeOfPolynomial(((BinaryOperation) leftFactor).getLeft(), var).compareTo(BigInteger.valueOf(2)) == 0) {
    ...
    private static Expression integrateReciprocalOfSqrtOfQuadraticFunction(Operator expr) throws EvaluationException, NotAlgebraicallyIntegrableException {
        ...
        ExpressionCollection coefficients = SimplifyPolynomialUtils.getPolynomialCoefficients(((BinaryOperation) ((BinaryOperation) f).getRight()).getLeft(), var);
    ...
    public static Expression integrateQuotientOfPolynomialAndOddPowerOfSqrtOfQuadraticPolynomial(Operator expr) throws EvaluationException, NotAlgebraicallyIntegrableException {
        ...
        ExpressionCollection[] quotient = SimplifyPolynomialUtils.polynomialDivision(coefficientsNumerator, coefficientsOfPowerOfQuadraticPolynomial);
        ...
        if (2 * n + 1 > 2 * maxExponent) {
            firstSummand = SimplifyPolynomialUtils.getPolynomialFromCoefficients(quotient[0], var).div(SimplifyPolynomialUtils.getPolynomialFromCoefficients(coefficientsDenominator, var).pow(2 * n - 2 * maxExponent + 1, 2));
        } else {
            firstSummand = SimplifyPolynomialUtils.getPolynomialFromCoefficients(quotient[0], var).mult(SimplifyPolynomialUtils.getPolynomialFromCoefficients(coefficientsDenominator, var).pow(2 * maxExponent - 2 * n - 1, 2));
        }
        secondSummand = SimplifyPolynomialUtils.getPolynomialFromCoefficients(quotient[1], var).div(SimplifyPolynomialUtils.getPolynomialFromCoefficients(coefficientsDenominator, var).pow(2 * n + 1, 2));
        paramsFirstSummand[0] = firstSummand;
        paramsFirstSummand[1] = var;
        Expression integralOfFirstSummand = indefiniteIntegration(new Operator(TypeOperator.integral, paramsFirstSummand), true);
        Object[] paramsSecondSummand = new Object[2];
    ...
    public static Expression integrateRationalFunctionInExp(Operator expr) throws EvaluationException, NotAlgebraicallyIntegrableException {
        ...
        try {
             ...
             */
            if (!SimplifyRationalFunctionUtils.doArgumentsOfTrigonometricalFunctionsContainOnlyMultiplesOfVariable((Expression) fSubstituted, substVar)) {
                throw new NotAlgebraicallyIntegrableException();
            }
    ...
    public static Expression integrateRationalFunctionInTrigonometricFunctions(Operator expr) throws EvaluationException, NotAlgebraicallyIntegrableException {
        ...
        if (!SimplifyRationalFunctionUtils.isRationalFunktionInTrigonometricalFunctions(f, var, argumentsInTrigonometricalFunctions) || argumentsInTrigonometricalFunctions.isEmpty()) {
            throw new NotAlgebraicallyIntegrableException();
        }
        ...
        try {
             ...
             */
            fSubstituted = SimplifyRationalFunctionUtils.expandRationalFunctionInTrigonometricalFunctions(fSubstituted, substVar).simplify(simplifyTypesRationalTrigonometricalFunction);
            /*
    ...
    public static Expression integrateRationalFunctionInVarAndAnotherAlgebraicExpressionEquation(Operator expr) throws EvaluationException, NotAlgebraicallyIntegrableException {
        ...
        try {
            zerosOfAlgebraicTermMinusSubstVar = SolveGeneralEquationUtils.solveEquation(radicand, Variable.create(substVar).pow(ONE.div(exponent)), var);
        } catch (EvaluationException e) {
            throw new NotAlgebraicallyIntegrableException();
        }
    ...
    public static Expression integrateRationalFunctionInRationalPowerOfVar(Operator expr) throws EvaluationException, NotAlgebraicallyIntegrableException {
        ...
        if (fSubstituted.contains(var) || !SimplifyRationalFunctionUtils.isRationalFunction(fSubstituted, substVar)) {
            throw new NotAlgebraicallyIntegrableException();
        }
    ...
    private static BigInteger getExponentIfFunctionIsRationalFunctionInRationalPowerOfVar(Expression f, String var) throws NotRationalFunctionInRationalPowerOfVarException {
        ...
        for (Expression subst : setOfSubstitutions) {
            ...
            if (lcmOfExponentDenominator == null) {
                ...
                lcmOfExponentDenominator = ArithmeticUtils.lcm(lcmOfExponentDenominator,
        ...
        // Schließlich: Prüfung, ob f eine rationale Funktion in x und g(x) = radicand ist.
        if (!SimplifyRationalFunctionUtils.isRationalFunctionInFunctions(f, var, Variable.create(var).pow(BigInteger.ONE, lcmOfExponentDenominator))) {
            throw new NotRationalFunctionInRationalPowerOfVarException();
        }
