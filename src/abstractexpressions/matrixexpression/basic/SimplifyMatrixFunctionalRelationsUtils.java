...
public abstract class SimplifyMatrixFunctionalRelationsUtils {
    ...
    public static MatrixExpression simplifyPowerSeriesFunctionOfDiagonalizableMatrix(Matrix argument, TypeMatrixFunction type) {
        ...
        if (EigenvaluesEigenvectorsUtils.isMatrixDiagonalizable(argument)) {

            Object eigenvectorMatrix = EigenvaluesEigenvectorsUtils.getEigenvectorBasisMatrix(argument);
