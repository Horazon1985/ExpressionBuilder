...
"expr", "integer", "logexpr", "matexpr", "var", Suffix = "", "+" ("+" bedeutet
...
(4) Restriktionen: Bei Typ = "var": (a_1, ..., a_m), wobei a_i entweder die Form
...
darf.
(5) Folgende Form ist verboten: zwei aufeinanderfolgende Parameter besitzen denselben
