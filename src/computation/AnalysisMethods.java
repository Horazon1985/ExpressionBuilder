...
public class AnalysisMethods {
    ...
    public static Expression sum(Expression f, String var, int k_0, int k_1) {
        ...
        if ((k_0 <= -6 || k_1 >= 6) && (k_1 - k_0 >= 5)) {
            ...
            /**
             * Vorab-Test auf die Möglichkeit einer
             * "Zwischendurch-Vereinfachung" (s. o.)
             */
            if (k_0 <= -6) {
    ...
    public static BigDecimal getDigitsOfE(int n) throws ExpressionException {
        ...
        /**
         * bound = 10^(-n - 5). Zusätzliche 5 Stellen sind für Rundungsfehler
         * gedacht.
         */
    ...
    public static double Gamma(double s) throws EvaluationException {
        ...
        if (s >= 1 && s < 2) {
            ...
            /**
             * Gilt !(s >= 1 && s < 2), wird die Funktionalgleichung Gamma(s +
             * 1) = s * Gamma(s) ausgenutzt, um das Argument wieder in den
