...
public class SubstitutionTest {
    ...
    public void substitutionTest1() {
        try {
            ...
            var = "x";
            substVar = Variable.create(SubstitutionUtilitiesNew.getSubstitutionVariable(f));
            f = SubstitutionUtilitiesNew.substitute(f, var, subst);
    ...
    public void substitutionTest2() {
        try {
            ...
            var = "x";
            substVar = Variable.create(SubstitutionUtilitiesNew.getSubstitutionVariable(f));
            f = SubstitutionUtilitiesNew.substitute(f, var, subst).simplify();
